...
<div class="container">
    <form action="/handlers/formHandler.php" method="POST" class="col-md-6 offset-md-3">
        <div class="row">
            <div class="col-lg-12 d-flex flex-column gap-3">
                <h2 class="mt-2 font-weight-light">Вход</h2>
                ...
                <div class="form-floating">
                    <input type="password" name="password" class="form-control" id="floatingInputPassword" placeholder="" required>
                ...
                <button type="submit" name="formName" value="signin" class="btn btn-md btn-block btn-danger-gradiant text-white border-0">Войти</button>
            </div>
        </div>
    </form>
    <div class="text-center mt-4">
        Нет учетной записи? <a href="/php/signup.php" class="text-danger">Зарегистрироваться</a>
    </div>
</div>
